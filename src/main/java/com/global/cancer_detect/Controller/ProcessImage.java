...
//--------------------------------------------------------------------------------------------------------
    ...
    @PostMapping("/upload")
    public ResponseEntity<Object> uploadImade(@RequestParam("image") MultipartFile image,@RequestParam("typeModel") Long typeModel ) throws IOException {
        return imageService.StoreImade(image);
    }
